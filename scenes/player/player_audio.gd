...
func _ready() -> void:
	...
	thud_stream.stream = preload("res://assets/sfx/hit-metallic-basketball-hoop-supports.wav") # preload("res://assets/sfx/heavy_thud.wav") # preload("res://assets/sfx/metal-thud.wav")
